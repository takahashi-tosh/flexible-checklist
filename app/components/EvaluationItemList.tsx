  ...
  return (
    <div className="space-y-6">
      ...
      {uncategorizedItems.length > 0 && (
        <div>
          <h3 className="text-lg font-bold text-zinc-700 dark:text-zinc-300 mb-3 pb-2 border-b-2 border-zinc-300 dark:border-zinc-700">
            未分類
          </h3>
      ...
      {parentCategories.map((parent, parentIndex) => {
        ...
        return (
          <div key={parent.id}>
            {/* 区分ヘッダー */}
            <h2 className="text-xl font-bold text-zinc-900 dark:text-zinc-100 mb-4 pb-2 border-b-2 border-blue-500 dark:border-blue-400">
            ...
            {Object.entries(group.children).map(([childId, childData], childIndex) => {
              ...
              return (
                <div key={childId} className="mb-6">
                  {/* 観点ヘッダー */}
                  <h3 className="text-base font-semibold text-zinc-700 dark:text-zinc-300 mb-3 pb-1 border-b border-zinc-300 dark:border-zinc-700">
