...
import { SupplementalInfoFieldTemplate } from '../types/supplemental-info-template';
import { FieldType } from '../types/supplemental-info';

interface SupplementalInfoFieldCanvasProps {
  fields: Omit<SupplementalInfoFieldTemplate, 'id' | 'createdAt' | 'updatedAt'>[];
  expandedFields: Set<number>;
  onToggleExpand: (index: number) => void;
  onUpdateField: (index: number, updates: Partial<Omit<SupplementalInfoFieldTemplate, 'id' | 'createdAt' | 'updatedAt'>>) => void;
...
function SortableField({ 
  ...
  field: Omit<SupplementalInfoFieldTemplate, 'id' | 'createdAt' | 'updatedAt'>;
  index: number;
  isExpanded: boolean;
  onToggleExpand: () => void;
  onUpdateField: (updates: Partial<Omit<SupplementalInfoFieldTemplate, 'id' | 'createdAt' | 'updatedAt'>>) => void;
  onRemoveField: () => void;
}) {
...
export default function SupplementalInfoFieldCanvas({ fields, expandedFields, onToggleExpand, onUpdateField, onRemoveField }: SupplementalInfoFieldCanvasProps) {
  const { setNodeRef, isOver } = useDroppable({
    id: 'supplemental-info-field-canvas',
  });
